...
if is_dir_empty "${MONGODB_DATA_DIR}/db"; then
    ...
    current_primary=$(mongosh admin --host $MONGODB_LIST --authenticationDatabase admin -u root -p $MONGODB_ROOT_PASSWORD --eval 'db.runCommand("ismaster")' | awk -F\' '/primary/ {print $2}')
